// rebota contra las paredes izquierda y derecha y el piso
#include <iostream>
#include <fstream>
#include <vector>
#include <cmath>
...
int main(void)
{
  ...
  // processing // e imprime posicion y velocidad
  for (int step = 0; step < 1000; ++step) {
    ...
    //print_csv(bodies, step); // imprime archivos.csv
  }
...
void initial_conditions(std::vector<body> & bodies)
{
  ...
  bodies[0].r[2] = 7.86;
  bodies[0].v[0] = 0.87; //para que se mueva hacia la derecha
  bodies[0].v[2] = 1.32;
}
